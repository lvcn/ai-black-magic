...
# 🧙‍♂️ AI Black Magic / AI 黑魔法

### 一个技能文件，让 AI 拥有十年架构师的能力

[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](LICENSE)
[![Stars](https://img.shields.io/github/stars/你的用户名/ai-black-magic?style=social)](https://github.com/你的用户名/ai-black-magic)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/你的用户名/ai-black-magic/pulls)

**别人用 AI 写 Hello World，你用 AI 做架构评审。**

[快速开始](#-三步起飞) · [技能清单](#-技能清单) · [路线图](#-路线图) · [参与贡献](#-参与贡献)
...
而这个仓库里的每一个 **Skill File（技能文件）**，都是一份精心编写的**系统级指令**——把它丢给 AI（Cursor / Copilot / ChatGPT / Claude），AI 瞬间变成某个领域的资深专家。
...
```bash
git clone https://github.com/你的用户名/ai-black-magic.git
```
...
我们按照**真实开发流程**来组织技能文件，覆盖程序员工作的方方面面：
